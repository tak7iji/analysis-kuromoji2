...
public class Kuromoji2JapaneseStopTokenFilterFactory extends AbstractTokenFilterFactory{
    ...
    public Kuromoji2JapaneseStopTokenFilterFactory(IndexSettings indexSettings, Environment env, String name, Settings settings) {
