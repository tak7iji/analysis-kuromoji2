...
/**
 */
public class Kuromoji2TokenizerFactory extends AbstractTokenizerFactory {
    ...
    public Kuromoji2TokenizerFactory(IndexSettings indexSettings, Environment env, String name, Settings settings) {
